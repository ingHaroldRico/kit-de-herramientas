...
function icm(){
    if(peso.value=="" || altura.value==""){
        ...
        resul=(peso1)/(altura1*altura1)
         ...
         if(resul <=16){
             imagen.src="imagenes/desnutricion.jpg"
